...
## [0.6.1]
- clean up dependencies [#9](https://github.com/mjohns/vscode-clang-format-provider/issues/9)

## [0.6.0]
- fixed multibyte character handling [#7](https://github.com/mjohns/vscode-clang-format-provider/issues/7) (by [OWenT](https://github.com/owt5008137))
- fixed "clang-format is ignoring the -style setting because of invalid value" [#6](https://github.com/mjohns/vscode-clang-format-provider/issues/6) (by [OWenT](https://github.com/owt5008137))
- LLVM style is now the default fallback style (fixes [#1](https://github.com/mjohns/vscode-clang-format-provider/issues/1))
