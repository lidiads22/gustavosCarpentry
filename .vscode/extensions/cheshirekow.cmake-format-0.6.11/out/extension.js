...
function getWorkspaceFolder() {
    ...
    if (!editor) {
        vscode.window.showErrorMessage("Unable to get the location of cmake-format executable"
            + " - no active workspace selected");
        return undefined;
    }
    if (!vscode.workspace.workspaceFolders) {
        vscode.window.showErrorMessage("Unable to get the location of clang-format executable"
    ...
    if (!workspacePath) {
        ...
        vscode.window.showWarningMessage("Unable to deduce the location of clang-format executable for file"
